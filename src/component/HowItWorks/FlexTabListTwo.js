        ...
        <Grid templateColumns='repeat(4,1fr)' gap={6}>
          <Box  position="relative" bgColor="white" paddingBottom="5">
            ...
            <Image
              ...
              justifyContent="left"
            />
            <Text paddingLeft="2" paddingTop="2"> Book an Appointment</Text>
          ...
          <Box  position="relative" bgColor="white" paddingBottom="5">
            ...
            <Image
              ...
              justifyContent="left"
            />
            <Text paddingLeft="2" paddingTop="2">Free Motor Inspection</Text>
            <Text fontSize="12" marginY="2" paddingLeft="2" paddingTop="2"> 
          ...
          <Box  position="relative" bgColor="white" paddingBottom="5">
            ...
            <Image
              ...
              justifyContent="left"
            />
            <Text paddingLeft="2" paddingTop="2"> Sell Your Motor</Text>
            <Text fontSize="12" marginY="2" paddingLeft="2" paddingTop="2"> 
            Accept our offer on the spot, or opt for bidding with Carsome's network of dealers!
            </Text>
          </Box>
          ...
          <Box  position="relative" bgColor="white" paddingBottom="5">
            ...
            <Image
              ...
              justifyContent="left"
            />
            <Text paddingLeft="2" paddingTop="2"> Get Paid in 1 Hour</Text>
            <Text fontSize="12" marginY="2" paddingLeft="2" paddingTop="2"> 
